...
def hangman():
    ...
    for i in range(length):
        word[i] = chosen_Word[i]
    
    trial = check(length, word, chances)

    if length == len(trial):
        print('you guessed it, the word is ', chosen_Word)
    elif chances <= 0 :
        print('drat, you lose. the word was ', chosen_Word)


def check(length, word, chances):
